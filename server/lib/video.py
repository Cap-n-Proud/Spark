...
directory_path = '/home/pi/GoPiGo3/Projects/RemoteCameraRobot/static'
...
class StreamingHandler(server.BaseHTTPRequestHandler):
   ...
   # Using cv2.rectangle() method
                    ...
                    #print(frame)
                    f=cv2.imread(str(frame))
                    f = cv2.rectangle(f, start_point, end_point, color, thickness)
                    #frame = cv2.imencode('.JPEG', f)
