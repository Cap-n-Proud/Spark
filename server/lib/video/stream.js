...
videoCap.set(cv.CAP_PROP_FRAME_WIDTH, 320);
videoCap.set(cv.CAP_PROP_FRAME_HEIGHT, 240);
//videoCap.set(cv.CAP_PROP_DSHOW, 1);
...
const stream = (server) => {
	...
	//cv.imwrite('./public/output.jpg', frame);
	//const frame = videoCap.read();
