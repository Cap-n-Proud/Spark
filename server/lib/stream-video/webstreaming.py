...
def detect_motion(frameCount):
	...
	while True:
		...
		#Resolution
		cv2.putText(frame, str(frame.shape[0]), (frame.shape[1] - 70, frame.shape[0] - lineSpace), cv2.FONT_HERSHEY_SIMPLEX, 0.35, (0, 255, 0), 1)
		cv2.putText(frame, "x", (frame.shape[1] - 50, frame.shape[0] - lineSpace), cv2.FONT_HERSHEY_SIMPLEX, 0.35, (0, 255, 0), 1)
