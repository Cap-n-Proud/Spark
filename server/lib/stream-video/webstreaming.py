...
def detect_motion(frameCount):
	...
	while True:
		...
		cv2.putText(frame, "x", (frame.shape[1] - 75, frame.shape[1] - lineSpace), cv2.FONT_HERSHEY_SIMPLEX, 0.35, (0, 255, 0), 1)
		cv2.putText(frame, str(frame.shape[1]), (frame.shape[1] - 65, frame.shape[0] - lineSpace), cv2.FONT_HERSHEY_SIMPLEX, 0.35, (0, 255, 0), 1)
